...
it must be placed in as a folder level script in the users folder as in the example below

C:\Users\demian\AppData\Roaming\Adobe\Acrobat\Privileged\10.0\JavaScripts
*/
...
// If the OK button is pressed the below instructions will process

if("ok"==app.execDialog(oWarrantDialog))
{
// This just tests to see what the variables contains
//	Prints out to the javascript debugger.
...
/* // From this point on is where the annotation is actually built
The annotation can not just be wrritten into  but is composed of an array
which I have called spans. each span  below results in 1 entry in  the annotation. 
spans[0] contains the DL and Pntrv information. Since that information is always included I 
don't need to check for a condition*/ 
...
/* // Now I have to check if the user has entered any diary dates and if so
add Diary date and diary date remarks to the annotation */
...
/* // Now I have to check if the user has entered any fta information and if so
add them to the annotation */

if(oWarrantDialog.strFtaDate != ""){		
spans[4] = new Object();
...
/* // Now I have to check if the user has entered any ORI information and if so
which ORI's and then add them to the annotation */


if(oWarrantDialog.strOri == "Ori1" && oWarrantDialog.strProbation == "Pro2"){		
spans[5] = new Object();
spans[5].textStyle = "bold";
spans[5].textColor = color.blue;
spans[5].textSize = 9;
spans[5].fontFamily = ["Arial Black", "monospace" ];
spans[5].text = "\r\rADD ORI:\rON80322";
}


if(oWarrantDialog.strOri == "Ori2" && oWarrantDialog.strProbation == "Pro2"){
spans[5] = new Object();
spans[5].textStyle = "bold";
spans[5].textColor = color.blue;
spans[5].textSize = 9;
spans[5].fontFamily = ["Arial Black", "monospace" ];
spans[5].text = "\r\rADD ORI:\rON80360";
}
...
page: 0,
type: "FreeText",
//The rect array consists of four numbers [xll, yll, xur, yur] specifying the lower-left x, lower-left y, upper-right x, and upper-right y coordinates—in default user space—of the rectangle defining the location of the annotation on the page
//rect: [350, 300, 600, 700], 
//rect: [340, 400, 600, 700], // 340 & 600 are good
rect: [390, 480, 600, 700], // perfect
richContents: spans
});
}
